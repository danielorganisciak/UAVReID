...
class TemporallyNear(ImageDataset):

    dataset_dir = 'drone-reid/temporally-near'

    def __init__(self, root='', split_id=0, **kwargs):
        self.root = osp.abspath(osp.expanduser(root))
        self.dataset_dir = osp.join(self.root, self.dataset_dir)

        self.cam_a_dir = osp.join(self.dataset_dir, 'view_0')
        self.cam_b_dir = osp.join(self.dataset_dir, 'view_1')
        ...
        super(TemporallyNear, self).__init__(train, query, gallery, **kwargs)
